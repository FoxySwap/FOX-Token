...
contract FOX is ERC20Interface, SafeMath {
     ...
     */
    constructor() public {
        name = "FOX"; // Name of the Token
        symbol = "FOX"; // Symbol of the Token
        decimals = 18; // Decimal Values
        _totalSupply = 50000000000000000000000000; // 50,000,000 = Supply
